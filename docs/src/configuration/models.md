...
| **whisper** | State-of-the-art multilingual speech-to-text. | [Arxiv](https://arxiv.org/abs/2212.04356) |
...
* **Inputs:**
    * `audio` (Required): String path or base64 encoded audio.
    * `task`: `transcribe` or `translate`.
    * `enable_diarization`: Identify different speakers.
* **Outputs:**
    * `text`: Full transcript.
    * `chunks`: Segmented text with `timestamp`, `speaker`, and optional `speaker_embedding`.
