...
<template>
  <div class="h-screen w-screen bg-slate-50 overflow-hidden flex flex-col font-sans antialiased text-slate-800">
    ...
    <div class="flex flex-1 overflow-hidden relative">
      ...
      <NavbarAction v-if="hasSelection" class="flex-shrink-0 border-l border-slate-200" />
    </div>
