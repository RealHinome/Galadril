...
use mistralrs::{
    Agent, AgentBuilder, AgentStopReason, AutoDeviceMapParams,
    DeviceMapSetting, IsqBits, MemoryGpuConfig, ModelBuilder,
...
impl Scribe {
    ...
    pub async fn new(
        ...
        let paged_attn_meta = PagedAttentionMetaBuilder::default()
            .with_block_size(32)
            .with_gpu_memory(MemoryGpuConfig::ContextSize(2048))
            .build()?;
        ...
        let model = ModelBuilder::new(&config.model_id)
            .with_logging()
